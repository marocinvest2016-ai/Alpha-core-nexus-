...
with tab2:
    ...
    if not github_token:
        ...
        file_content = st.text_area("محتوى الملف:", value="وكالة تساوت الرقمية للعقار والأعمال بقلعة السراغنة\n📞 للتواصل: 0691897126")
        commit_msg = st.text_input("رسالة Commit:", value="Update descriptions.txt")
